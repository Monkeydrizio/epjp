...
public class S44_chicken {
	...
	public String toString() {
		...
		String result; // = "["+ name + "," + weight + "," + female +"]"; brutto e poco leggibile

		result = String.format("%s, %f, %b", name, weight, female); // strutta della stringa con % e carattere del tipo di dato da inserire, poi i dati da inserire
